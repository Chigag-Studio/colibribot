...
#lyghtcode 2022 small changes to order book message. We're only using symbols. No trading pairs.

class AlpacaOrderBookMessage(OrderBookMessage):
    def __new__(
        cls,
        ...
        **kwargs,
        ...
        return super(AlpacaOrderBookMessage, cls).__new__(
