...
from hummingbot.connector.exchange.alpaca.alpaca_utils import convert_from_exchange_trading_pair, \
        ...
        async with throttler.execute_task(CONSTANTS.GET_TRADING_PAIRS_PATH_URL):
            ...
            if response.status == 200:
                try:
                    ...
                    pass
                    # Do nothing if the request fails -- there will be no autocomplete for alpaca trading pairs
            return []
